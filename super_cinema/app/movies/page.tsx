...
import { Star, Clock, Calendar, ArrowLeft, Search, User } from "lucide-react"
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-lg text-muted-foreground">
                Discover our complete selection of current movies and book your tickets
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {featuredMovies.map((movie) => (
              <Card
                key={movie.id}
                className="group overflow-hidden hover:scale-105 transition-all duration-300 hover:shadow-lg"
              >
